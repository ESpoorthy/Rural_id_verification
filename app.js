...
// For local development, use localhost. For production, update with your API Gateway URL
// If API is not available, the app will show a demo message
const API_BASE_URL = window.location.hostname === 'localhost' 
    ? 'http://localhost:8000/api/v1'
    : 'http://localhost:8000/api/v1'; // Change to your API Gateway URL when backend is deployed
