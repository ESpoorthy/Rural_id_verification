...
class TestGeoLocation:
    ...
    def test_geo_location_creation(self):
        ...
        location = GeoLocation(latitude=40.7128, longitude=-74.0060, accuracy=10.0)
...
class TestAuthenticationAttempt:
    ...
    def test_authentication_attempt_creation(self):
        ...
        attempt = AuthenticationAttempt(method=AuthenticationMethod.FACE_ID, success=True)
    ...
    def test_authentication_attempt_with_failure(self):
        ...
        attempt = AuthenticationAttempt(
            method=AuthenticationMethod.PIN, success=False, failure_reason="Invalid PIN"
        )
...
class TestAuthenticationSession:
    ...
    def test_add_attempt(self, sample_auth_session):
        ...
        attempt = sample_auth_session.add_attempt(method=AuthenticationMethod.FACE_ID, success=True)
    ...
    def test_is_expired_true(self, sample_auth_session):
        ...
        sample_auth_session.expires_at = datetime.now(UTC) - timedelta(minutes=1)
