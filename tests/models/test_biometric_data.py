...
class TestBiometricTemplate:
    ...
    def test_template_requires_user_id(self):
        ...
        with pytest.raises(ValueError, match="User ID is required"):
            BiometricTemplate(user_id=None, feature_vector=secrets.token_bytes(256))
    ...
    def test_template_requires_feature_vector(self):
        ...
        with pytest.raises(ValueError, match="Feature vector is required"):
            BiometricTemplate(user_id=uuid4(), feature_vector=None)

        with pytest.raises(ValueError, match="Feature vector is required"):
            BiometricTemplate(user_id=uuid4(), feature_vector=b"")
    ...
    def test_quality_score_validation(self):
        ...
        for score in [0.0, 0.5, 1.0]:
            template = BiometricTemplate(
                user_id=user_id, feature_vector=feature_vector, quality_score=score
            )
    ...
    def test_template_to_dict(self):
        ...
        template = BiometricTemplate(
            user_id=user_id, feature_vector=feature_vector, quality_score=0.85, metadata=metadata
        )
    ...
    def test_template_from_dict(self):
        ...
        original_template = BiometricTemplate(
            user_id=user_id, feature_vector=feature_vector, quality_score=0.75
        )
...
class TestEncryptedBiometricData:
    ...
    def test_encrypt_template(self):
        ...
        template = BiometricTemplate(
            user_id=user_id, feature_vector=feature_vector, quality_score=0.9
        )
    ...
    def test_verify_integrity_valid(self):
        ...
        user_id = uuid4()
        template = BiometricTemplate(
            user_id=user_id, feature_vector=secrets.token_bytes(256), quality_score=0.9
        )
    ...
    def test_is_expired(self):
        ...
        encrypted_data.created_at = datetime.now(UTC) - timedelta(days=400)
...
class TestBiometricDataManager:
    ...
    def test_store_and_retrieve_template(self):
        ...
        template = BiometricTemplate(
            user_id=user_id, feature_vector=secrets.token_bytes(256), quality_score=0.92
        )
