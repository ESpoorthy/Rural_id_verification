...
class TestFamilyMember:
    ...
    def test_default_authorization_level(self):
        ...
        family_member = FamilyMember(primary_user_id=uuid4(), relationship=Relationship.CHILD)
    ...
    def test_grant_consent(self):
        ...
        family_member = FamilyMember(primary_user_id=uuid4(), relationship=Relationship.SPOUSE)
    ...
    def test_consent_date_auto_set_on_creation(self):
        ...
        family_member = FamilyMember(
            primary_user_id=uuid4(), relationship=Relationship.SPOUSE, consent_given=True
        )
    ...
    def test_all_relationship_types(self):
        ...
        for relationship in Relationship:
            family_member = FamilyMember(primary_user_id=primary_user_id, relationship=relationship)
