...
class TestContactInfo:
    ...
    def test_contact_info_creation(self):
        ...
        info = ContactInfo(phone_number="+1234567890", alternate_contact="+0987654321")
...
class TestAuthenticationMethods:
    ...
    def test_custom_authentication_methods(self):
        ...
        methods = AuthenticationMethods(face_recognition=False, pin_enabled=True, otp_enabled=True)
...
class TestUser:
    ...
    def test_add_family_member(self, sample_user):
        ...
        family_member = FamilyMember(
            primary_user_id=sample_user.user_id, relationship=Relationship.SPOUSE
        )
